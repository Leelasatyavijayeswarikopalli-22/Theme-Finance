      ...
      <main className="flex-grow">
          ...
          <div className="container">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Vehicle Insurance</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
          ...
          <div className="container">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="opacity-90 mt-1">Protect your vehicle with our comprehensive insurance plans</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <CardContent>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <span>Legally required basic cover</span>
                  </li>
                  <li className="flex items-center">
                    <span className="bg-green-500 h-2 w-2 rounded-full mr-2"></span>
                    <span>Covers third-party damages</span>
                  </li>
                  <li className="flex items-center">
                    <span className="bg-green-500 h-2 w-2 rounded-full mr-2"></span>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Comprehensive Cover</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-blue-50 p-4 rounded-md mb-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <span className="bg-green-500 h-2 w-2 rounded-full mr-2"></span>
                    <span>Third-party and own damage cover</span>
                  </li>
                  <li className="flex items-center">
                    <span className="bg-green-500 h-2 w-2 rounded-full mr-2"></span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-blue-50 p-4 rounded-md mb-4">
                  <p className="text-xl font-semibold text-blue-600">From ₹4,000</p>
                  <p className="text-sm text-gray-500">Annual Premium</p>
                </div>
                <ul className="space-y-2">
                  <li className="flex items-center">
